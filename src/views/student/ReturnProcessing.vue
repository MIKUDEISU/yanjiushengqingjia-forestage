<template>
  <div class="page-container">
    <header class="view-header"><h1>返校审批中</h1></header>

    <div class="page-content" v-if="leave">
      <div class="info-banner">
        <div class="info-banner__icon"></div>
        <div class="info-banner__title">返校申请进行中</div>
        <div class="info-banner__desc">审批人：<strong>{{ leave.currentApprover || '—' }}</strong></div>
      </div>

      <div class="content-card">
        <div class="section-title">返校概况</div>
        <div class="summary-grid">
          <div class="summary-item"><div class="summary-label">原请假</div><div class="summary-value">{{ leave.duration }}天</div></div>
          <div class="summary-item"><div class="summary-label">到期日</div><div class="summary-value">{{ leave.endDate }}</div></div>
          <div class="summary-item"><div class="summary-label">学生</div><div class="summary-value">{{ leave.studentName }}</div></div>
          <div class="summary-item"><div class="summary-label">状态</div><div class="summary-value"><span class="status-tag status-tag--processing">审核中</span></div></div>
        </div>
      </div>
      ...
      <div class="action-bar">
        <div class="action-note">返校审批完成后将通过消息通知您</div>
      </div>
    </div>
  </div>
</template>
